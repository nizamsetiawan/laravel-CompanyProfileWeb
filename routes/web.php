...
//Route tambah ormawa
    Route::get('/ormawa', 'AdminController@ormawaAddShow')->name('admin.ormawa.show');
    Route::post('/ormawa', 'AdminController@ormawaStore')->name('admin.ormawa.store');
    // Route Edit Ormawa
    Route::get('/ormawa/update', 'AdminController@ormawaEditShow')->name('ormawa.show');
    Route::get('/ormawa/update/{id}', 'AdminController@ormawaEdit')->name('ormawa.edit');
    Route::post('/ormawa/update', 'AdminController@ormawaEditUpdate')->name('ormawa.update');
    // Route Hapus Ormawa
    Route::get('/ormawa/delete', 'AdminController@ormawaDeleteShow')->name('ormawa.delete');
    Route::delete('/ormawa/delete/{id}', 'AdminController@ormawaDestroy')->name('ormawa.destroy');
