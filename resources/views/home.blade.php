...
Line : <strong>@541vnpky</strong>',
        ...
        ['question' => 'ST/SK/Surat Undangan apabila belum turun pada saat mengupload, bagaimana solusinya?', 'answer' => 'Sebaiknya menunggu hingga ST/SK/Surat Undangan turun terlebih dahulu, baru mengisi GForm tersebut.'],

        ['question' => 'Bagaimana cara untuk dapat melakukan peminjaman inventaris ?', 'answer' => 'Peminjaman inevntaris dapat menghubungi divisi HRD melalui OA Line : <strong>@541vnpky</strong>'],
...
.',
        ...
        ['question' => 'Apakah peminjaman inventaris di BEM FT diperuntukkan juga bagi ormawa di luar Fakultas Teknik?', 'answer' => 'Iya, ormawa di luar Fakultas Teknik juga dapat meminjam inventaris, namun akan dikenakan biaya perawatan.'],

        ['question' => 'Untuk request publikasi harus menghubungi siapa?', 'answer' => 'untuk publikasi bisa langsung dm ke instagram @bem_ft_ubaya'],

        ['question' => 'Apakah boleh mengirimkan bahan publikasi h-1', 'answer' => 'tidak boleh ya, untuk pengiriman paling tidak h-7 sebelum kegiatan dilaksanakan'],

        ['question' => 'Untuk publikasi akan dishare melalui apa?', 'answer' => 'segala publikasi akan dishare melalui story instagram @bem_ft_ubaya'],

        ['question' => 'Apakah publikasi bisa melalui feeds instagram? Kalau iya, mekanismenya bagaimana?', 'answer' => 'bisa publikasi melalui feeds, untuk mekanismenya harus mengirimkan bahan publikasi paling tidak h-21 acara'],

        ['question' => 'Untuk Kalender Teknik, apakah ada batas waktu pengisiannya?', 'answer' => 'tentu saja ada, batas waktu pengisian setiap tanggal 20 pada setiap bulannya'],

        ['question' => 'Apa saja ketentuan kegiatan yang akan diinputkan pada Kalender Teknik?', 'answer' => 'kegiatan yang diinputkan merupakan kegiatan eksternal, yang ingin disebarluaskan, serta butuh bantuan publikasi'],

        ['question' => 'Kalender Teknik akan dishare melalui apa?', 'answer' => 'Kalender Teknik akan dishare melalui feeds instagram @bem_ft_ubaya serta website official bemft'],
    ];
@endphp
...
@section('content')
    ...
    <div id="theme-main-banner" class="banner-one">
        ...
        <div data-src="{{ asset('bemft_assets/images/home/2.png') }}">
            <div class="camera_caption">
                <div class="container">
                    <p class="wow fadeInUp animated" style="color:#f6f6f6">Jelajahi Ormawa Secara Virtual!</p>
        ...
        <div data-src="{{ asset('bemft_assets/images/home/6.png') }}">
            <div class="camera_caption">
                <div class="container">
                    <p class="wow fadeInUp animated" style="color:#f6f6f6">BEM UNESA 2024/2025</p>
                    <h1 class="wow fadeInUp animated" style="color:#f6f6f6" data-wow-delay="0.2s">Badan Eksekutif Mahasiswa
	...
	<div class="container clearfix">
		<h3 class="title">Website Official BEM UNESA</h3>
    ...
    <div class="our-team section-spacing">
        <div class="container">
            <div class="theme-title-one" style="margin-bottom:-30px" data-aos="fade-up"
                                            ...
                                            <div class="panel-heading">
                                                <h6 class="panel-title">
                                                    <a class="pr-5"
                                                        ...
                                                        href="#collapse{{ $loop->index }}" data-aos="fade-right">
                                                        {!! $faq['question'] !!}
                                                    </a>
                                                </h6>
                                            </div>
                            ...
                            @foreach ($galleris as $galleri)
                                <div class="item">
                                    <div class="single-blog">
                                        <div class="image-box">
                                            <img src="{{ asset('/' . $galleri->link_foto) }}"
                                                style="max-height:260px; width:auto;" alt="Dokumentasi Program Kerja">
                                            <div class="overlay"><a href="#"
                                                    class="date">{{ $galleri->tanggal }}</a></div>
                                        </div>
                                        <div class="post-meta">
                                            <h5 class="title"><a
                                                    href="/galeri/{{ $galleri->slug }}">{{ $galleri->nama }}</a></h5>
                                            <a href="/galeri/{{ $galleri->slug }}"
                                                class="read-more">{{ Str::limit($galleri->deskripsi, 80, '...') }}</a>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
