    ...
    <nav id="mega-menu-holder" class="clearfix">
        <ul class="clearfix" style="text-align:center;">
            ...
            @else
                ...
                <li
                    class="{{ request()->is('admin/ormawa') ? 'active' : '' }}{{ request()->is('admin/ormawa/update') ? 'active' : '' }}">
                    <a style="pointer-events: none; cursor: default;" href="#">Ormawa</a>
                    <ul class="dropdown">
                        <li class="">
                            <a href="{{ route('admin.ormawa.show') }}">Tambah Ormawa</a>
                        </li>
                        <li class="">
                            <a href="{{ route('ormawa.show') }}">Edit Ormawa</a>
                        </li>
                        <li class="">
                            <a href="{{ route('ormawa.delete') }}">Hapus Ormawa</a>
                        </li>
                    </ul>
                <li
                    class="{{ request()->is('admin/galeri') ? 'active' : '' }}{{ request()->is('admin/galeri/update') ? 'active' : '' }}">
                ...
                <li
                    class="{{ request()->is('admin/pengumuman') ? 'active' : '' }}{{ request()->is('admin/pengumuman/update') ? 'active' : '' }}">
