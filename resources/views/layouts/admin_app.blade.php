...
<head>
    ...
    <!-- Theme color -->
    <link id="jssDefault" rel="stylesheet" href="{{ asset('bemft_assets/css/color-default.css') }}">
                    ...
                    <div class="bg-wrapper clearfix d-flex justify-content-center align-items-center ">
                        <div class="logo float-left">
                            <a href="{{ route('beranda') }}"><img
                                    src="{{ asset('bemft_assets/images/logo/navbar-1.png') }}"
                                    style="max-width:165px; height:auto;" alt=""></a>
                        </div>
